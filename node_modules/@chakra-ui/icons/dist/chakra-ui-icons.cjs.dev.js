...
const AddIcon = icon.createIcon({
  d: "M0,12a1.5,1.5,0,0,0,1.5,1.5h8.75a.25.25,0,0,1,.25.25V22.5a1.5,1.5,0,0,0,3,0V13.75a.25.25,0,0,1,.25-.25H22.5a1.5,1.5,0,0,0,0-3H13.75a.25.25,0,0,1-.25-.25V1.5a1.5,1.5,0,0,0-3,0v8.75a.25.25,0,0,1-.25.25H1.5A1.5,1.5,0,0,0,0,12Z",
  displayName: "AddIcon"
});

const SmallAddIcon = icon.createIcon({
  displayName: "SmallAddIcon",
  viewBox: "0 0 20 20",
  path: /*#__PURE__*/React__namespace.createElement("path", {
    fill: "currentColor",
...
const SettingsIcon = icon.createIcon({
  viewBox: "0 0 14 14",
...
const CheckCircleIcon = icon.createIcon({
  displayName: "CheckCircleIcon",
  d: "M12,0A12,12,0,1,0,24,12,12.014,12.014,0,0,0,12,0Zm6.927,8.2-6.845,9.289a1.011,1.011,0,0,1-1.43.188L5.764,13.769a1,1,0,1,1,1.25-1.562l4.076,3.261,6.227-8.451A1,1,0,1,1,18.927,8.2Z"
});

const LockIcon = icon.createIcon({
...
const UnlockIcon = icon.createIcon({
...
const ViewIcon = icon.createIcon({
...
const ViewOffIcon = icon.createIcon({
...
const DownloadIcon = icon.createIcon({
...
const DeleteIcon = icon.createIcon({
...
const RepeatIcon = icon.createIcon({
...
const RepeatClockIcon = icon.createIcon({
...
const EditIcon = icon.createIcon({
...
const ChevronLeftIcon = icon.createIcon({
  d: "M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z",
  displayName: "ChevronLeftIcon"
});

const ChevronRightIcon = icon.createIcon({
  d: "M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z",
  displayName: "ChevronRightIcon"
});

const ChevronDownIcon = icon.createIcon({
  displayName: "ChevronDownIcon",
  d: "M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z"
});

const ChevronUpIcon = icon.createIcon({
  d: "M12 8l-6 6 1.41 1.41L12 10.83l4.59 4.58L18 14z",
  displayName: "ChevronUpIcon"
});

const ArrowBackIcon = icon.createIcon({
  d: "M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z",
  displayName: "ArrowBackIcon"
});

const ArrowForwardIcon = icon.createIcon({
  d: "M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z",
  displayName: "ArrowForwardIcon"
});

const ArrowUpIcon = icon.createIcon({
  d: "M4 12l1.41 1.41L11 7.83V20h2V7.83l5.58 5.59L20 12l-8-8-8 8z",
  displayName: "ArrowUpIcon"
});

const ArrowUpDownIcon = icon.createIcon({
  viewBox: "0 0 16 16",
...
const ArrowDownIcon = icon.createIcon({
  d: "M20 12l-1.41-1.41L13 16.17V4h-2v12.17l-5.58-5.59L4 12l8 8 8-8z",
  displayName: "ArrowDownIcon"
});

const ExternalLinkIcon = icon.createIcon({
...
const LinkIcon = icon.createIcon({
...
const PlusSquareIcon = icon.createIcon({
...
const CalendarIcon = icon.createIcon({
...
const ChatIcon = icon.createIcon({
...
const TimeIcon = icon.createIcon({
...
const ArrowRightIcon = icon.createIcon({
...
const ArrowLeftIcon = icon.createIcon({
...
const AtSignIcon = icon.createIcon({
...
const AttachmentIcon = icon.createIcon({
...
const PhoneIcon = icon.createIcon({
...
const DragHandleIcon = icon.createIcon({
  viewBox: "0 0 10 10",
...
const SpinnerIcon = icon.createIcon({
  displayName: "SpinnerIcon",
  path: /*#__PURE__*/React__namespace.createElement(React__namespace.Fragment, null, /*#__PURE__*/React__namespace.createElement("defs", null, /*#__PURE__*/React__namespace.createElement("linearGradient", {
    x1: "28.154%",
    y1: "63.74%",
    x2: "74.629%",
    y2: "17.783%",
...
const CloseIcon = icon.createIcon({
  displayName: "CloseIcon",
  d: "M.439,21.44a1.5,1.5,0,0,0,2.122,2.121L11.823,14.3a.25.25,0,0,1,.354,0l9.262,9.263a1.5,1.5,0,1,0,2.122-2.121L14.3,12.177a.25.25,0,0,1,0-.354l9.263-9.262A1.5,1.5,0,0,0,21.439.44L12.177,9.7a.25.25,0,0,1-.354,0L2.561.44A1.5,1.5,0,0,0,.439,2.561L9.7,11.823a.25.25,0,0,1,0,.354Z"
});

const SmallCloseIcon = icon.createIcon({
...
const QuestionOutlineIcon = icon.createIcon({
...
const MinusIcon = icon.createIcon({
...
const HamburgerIcon = icon.createIcon({
